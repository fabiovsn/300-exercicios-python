...
if(dq1 == dq2) and (id(dq1) != id(dq2)):
    print("Conjunto 1 e Conjunto 2 possuem os mesmos elementos, porém são objetos diferentes na memória")

if(dq1 == dq3) and (id(dq1) != id(dq3)):
    print("Conjunto 1 e Conjunto 3 possuem os mesmos elementos, porém são objetos diferentes na memória")

if(dq2 == dq3) and (id(dq2) != id(dq3)):
    print("Conjunto 2 e Conjunto 3 possuem os mesmos elementos, porém são objetos diferentes na memória")